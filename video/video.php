                        ...
                        <div class="module-group">
                            ...
                            <div class="module-content">
                                ...
                                <div class="playlist-item <?php echo $details_count == 1 ? 'active' : ''; $details_count++ ?>" onclick="playVideo(this, '<?= $module_title ?>')"
                                    data-video="<?= htmlspecialchars($module_details['video'], ENT_QUOTES, 'UTF-8') ?>"
                                    data-title="<?= htmlspecialchars($module_details['title'], ENT_QUOTES, 'UTF-8') ?>"
                                    >
                                    <div class="playlist-item-number">১</div>
                                    <div class="playlist-item-info">
                                        <div class="playlist-item-title"><?= htmlspecialchars($module_details['title'], ENT_QUOTES, 'UTF-8') ?></div>
                                        <div class="playlist-item-duration">
                                            <i class="far fa-clock"></i> <?= htmlspecialchars($module_details['time'], ENT_QUOTES, 'UTF-8') ?>
                                        </div>
                                    </div>
