...
if (!defined('PROJECT_PATH')) {
    define('PROJECT_PATH', 'http://localhost:8080/orian/cart'); // replace this value with your project path
}
...
if (!defined('STORE_ID')) {
    define('STORE_ID', 'defen68274a9c8e60c'); // your store id. For sandbox, register at https://developer.sslcommerz.com/registration/
}

if (!defined('STORE_PASSWORD')) {
    define('STORE_PASSWORD', 'defen68274a9c8e60c@ssl'); // your store password.
}
